...
***NOTE: 
Windows have varying difficulty from level 3 (easiest) to 6 (hardest) as indicated near the name. Difficult windows give more Favor Tokens***
...
- **Use 1 Tool Card** by spending Favor Tokens. Each action is optional — A player may choose to perform both actions, only one action or pass their turn taking no actions.
...
**Private Objective:** ***Shades of Purple*** would sum the values for purple dice (C1, C4, and A5), giving 5 + 6 + 6 = **17 VP** total.
